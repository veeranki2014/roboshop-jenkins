def call() {
    node('workstation') {
        ...
        stage('Code Checkout') {
            ...
            checkout scm: [$class: 'GitSCM', userRemoteConfigs: [[url: "https://github.com/veeranki2014/${env.component}"]], branches: [[name: gitbrname]]], poll: false
...
//        }
    ...
    if(env.TAG_NAME ==~ ".*") {
      stage('Publish a Artifact') {
        ...
        sh 'curl -v -u admin:admin123 --upload-file ${component}-${TAG_NAME}.zip http://172.31.44.132:8081/repository/${component}/${component}-${TAG_NAME}.zip'
      }
    }
